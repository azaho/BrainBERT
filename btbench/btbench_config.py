...
SAVE_SUBJECT_TRIAL_DF_DIR = "btbench/btbench_subject_metadata"
SAVE_SPEECH_SELECTIVITY_DATA_DIR = "btbench/btbench_speech_selectivity_data"
PITCH_VOLUME_FEATURES_DIR = "btbench/btbench_pitch_volume_features" # This comes together with the btbench package
SAMPLING_RATE = 2048 # Sampling rate

# No need to change the settings below because you can change these values dynamically when defining the splits using the functions from btbench_train_test_splits.py and the dataset from btbench_datasets.py
...
# Only used for the "Full" BTBench dataset
BTBENCH_FULL_SUBJECT_TRIALS = [
    (1, 0), (1, 1), (1, 2), 
...
BTBENCH_LONGEST_TRIALS_FOR_SUBJECT = {
    1: [0, 1],
    2: [4, 6],
    3: [2, 1],
    4: [2, 1],
