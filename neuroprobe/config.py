...
ROOT_DIR = "/om2/user/zaho/braintreebank_laplacian_rereferenced_line_noise_removed/" # Root directory for the braintreebank data. Recommended to use the absolute path.
